...
<body>
    ...
    <header class="p-3 shadow" id="fondo-encabezado">
        ...
        <div class="d-flex justify-content-between">
            <div>
                <a href="/" class="text-decoration-none px-3"> <strong class="text-light">Autoplast </strong> Urbina</a>
                <!-- ----logo---- -->
            </div>
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <main class="col-sm-9 col-12 pt-4 px-0" id="color-fondo-panel">
                ...
                <div class="w-100 cuerpo-final px-3 pt-2 border-top mt-4">
                    <p class="h-5">Sistema de Autoplast Urbina. &copy; 2022 </p>
                </div>
            </main>
        </div>
    </div>
