...
<body>
    ...
    <div class="invoice-box">
        ...
        <table class=" table table-hover table-bordered " cellspacing="0" style="width:100%">
            ...
            @if ($factura['vendido_A']==0)
                ...
                <tr>
                    <td colspan="3"></td>
                    <td>Resta :</td>
                    <td>{{number_format($factura['vendido_B']-$factura['pagado_B'],2)}}</td>
                </tr>
                @else
                <tr>
                    <td colspan="3"></td>
        ...
        <div class="text-center" style="margin-top: 30px;">
            *Los datos aquí presente muestran  información directa de la venta realizada hacia los clientes, ante una eventualidad de no coincidencia por favor comunicarse con el administrador  y/o responsable.*
            <hr class="w-50 bold">
        </div>
    </div>
</body>
