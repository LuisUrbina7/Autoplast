    ...
    <table id="example" class="table table-striped display nowrap" cellspacing="0" style="width:100%">
        ...
        <tbody id="tabla-cobranza">
            ...
            <tr>
                ...
                <td>
                    <div class="btn-group">
                        <a href="{{route('eliminar-cobranza',[$factura->id])}}" class="btn btn-danger" value="{{$factura->id}}" id="btnborrar"><i class="fa fa-trash" aria-hidden="true"></i>
                        </a>
                        <a href="{{route('detalles.cobranza',[$factura->idCliente,$factura->id])}}" class="btn btn-warning" value="{{$factura->id}}" id="btnver"><i class="fa fa-ticket" aria-hidden="true"></i>
                        </a>
                        <a href="{{ route('generarpdf',[$factura->idCliente,$factura->id]) }}" class="btn btn-info" value="{{$factura->id}}" target="_blank"><i class="fa fa-ticket" aria-hidden="true"></i>
                        </a>
