                ...
                success: function(response) {
                    ...
                    $.each(response, (index, item) => {
                        ...
                        if (item.Estado == 'Cancelada') {
                            contenido += '<tr><td>' + item.id + '</td><td>' + item.Fecha + '</td><td>' + item.Nombre + '</td><td>' + item.VendidoA + '</td><td>' + item.PagadoA + '</td><td>' + item.VendidoB + '</td><td>' + item.PagadoB + '</td><td ><p class="badge bg-secondary">' + item.Estado + '</p></td><td><a href="../deuda/detalles/'+item.proveedoresid+'/'+item.id+'" class="btn btn-info text-white">ver</a></td></tr>';
                        } else {
